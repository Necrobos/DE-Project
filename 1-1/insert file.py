...
with DAG(
    ...
    insert_ft_balance_f = PostgresOperator(
        task_id = 'insert_ft_balance_f',
        postgres_conn_id = 'pg-connection',
        sql = 'CALL ds.insert_ft_balance_f()'
    )

    insert_ft_posting_f = PostgresOperator(
        task_id = 'insert_ft_posting_f',
        postgres_conn_id = 'pg-connection',
        sql = 'CALL ds.insert_ft_posting_f()'
    )

    insert_md_account_d = PostgresOperator(
        task_id = 'insert_md_account_d',
        postgres_conn_id = 'pg-connection',
        sql = 'CALL ds.insert_md_account_d()'
    )

    insert_md_currency_d = PostgresOperator(
        task_id = 'insert_md_currency_d',
        postgres_conn_id = 'pg-connection',
        sql = 'CALL ds.insert_md_currency_d()'
    )
        
    insert_md_exchange_rate_d = PostgresOperator(
        task_id = 'insert_md_exchange_rate_d',
        postgres_conn_id = 'pg-connection',
        sql = 'CALL ds.insert_md_exchange_rate_d()'
    )

    insert_md_ledger_account_s = PostgresOperator(
        task_id = 'insert_md_ledger_account_s',
        postgres_conn_id = 'pg-connection',
        sql = 'CALL ds.insert_md_ledger_account_s()'
    )

    insert_ft_balance_f_start = create_log_task('insert_ft_balance_f', "Начало вставки в таблицу ft_balance_f схемы ds", 'start')
    insert_ft_balance_f_end = create_log_task('insert_ft_balance_f', "Вставка прошла успешно в таблицу ft_balance_f", 'end')

    insert_ft_posting_f_start = create_log_task('insert_ft_posting_f', "Начало вставки в таблицу ft_posting_f схемы ds", 'start')
    insert_ft_posting_f_end = create_log_task('insert_ft_posting_f', "Вставка прошла успешно в таблицу ft_posting_f", 'end')

    insert_md_account_d_start = create_log_task('insert_md_account_d', "Начало вставки в таблицу md_account_d схемы ds", 'start')
    insert_md_account_d_end = create_log_task('insert_md_account_d', "Вставка прошла успешно в таблицу md_account_d", 'end')

    insert_md_currency_d_start = create_log_task('insert_md_currency_d', "Начало вставки в таблицу md_currency_d схемы ds", 'start')
    insert_md_currency_d_end = create_log_task('insert_md_currency_d', "Вставка прошла успешно в таблицу md_currency_d", 'end')

    insert_md_exchange_rate_d_start = create_log_task('insert_md_exchange_rate_d', "Начало вставки в таблицу md_exchange_rate_d схемы ds", 'start')
    insert_md_exchange_rate_d_end = create_log_task('insert_md_exchange_rate_d', "Вставка прошла успешно в таблицу md_exchange_rate_d", 'end')

    insert_md_ledger_account_s_start = create_log_task('insert_md_ledger_account_s', "Начало вставки в таблицу md_ledger_account_s схемы ds", 'start')
    insert_md_ledger_account_s_end = create_log_task('insert_md_ledger_account_s', "Вставка прошла успешно в таблицу md_ledger_account_s", 'end')

    trunc_stage_start = create_log_task('truncate_all_stage_tables', "Начало удаления данных из всех таблиц", 'start')
    trunc_stage = PostgresOperator(
        task_id = 'trunc_stage',
        postgres_conn_id = 'pg-connection',
        sql = 'TRUNCATE TABLE stage.ft_balance_f, stage.ft_posting_f, stage.md_account_d, stage.md_currency_d, stage.md_exchange_rate_d, stage.md_ledger_account_s'
    )
    trunc_stage_end = create_log_task('truncate_all_stage_tables', "Удаление прошло успешно", 'end')
...
start >> trunc_stage_start >> trunc_stage >> trunc_stage_end >> \
    dag_start_log >> ft_balance_f_start >> ft_balance_f >> ft_balance_f_end >> \
    ...
    insert_ft_balance_f_start >> insert_ft_balance_f >> insert_ft_balance_f_end >> \
    insert_ft_posting_f_start >> insert_ft_posting_f >> insert_ft_posting_f_end >> \
    insert_md_account_d_start >> insert_md_account_d >> insert_md_account_d_end >> \
    insert_md_currency_d_start >>  insert_md_currency_d >>  insert_md_currency_d_end >> \
    insert_md_exchange_rate_d_start >>  insert_md_exchange_rate_d >>  insert_md_exchange_rate_d_end >> \
    insert_md_ledger_account_s_start >> insert_md_ledger_account_s >> insert_md_ledger_account_s_end >> \
    dag_end_log >> end
